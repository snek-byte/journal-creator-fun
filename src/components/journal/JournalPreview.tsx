          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="relative inline-block">
              ...
              {isUploadedImage && !isDialog && (
                <div 
                  className="absolute z-10 w-5 h-5 bg-white/40 hover:bg-white/70 rounded-full flex items-center justify-center cursor-pointer pointer-events-auto"
                  style={{
                    left: `${bgImagePosition.x}%`,
                    top: `${bgImagePosition.y - 5}%`,
